...
class Config(object):
    ...
    APP_ID = int(os.environ.get("APP_ID", 22627587))
    API_HASH = os.environ.get("API_HASH", 4f664b2a2bf3b095a689a51780a45a5e)
    # Get these values from my.telegram.org
    # Array to store users who are authorized to use the bot
    AUTH_USERS = set(int(x) for x in os.environ.get("AUTH_USERS", "5968801459").split())
